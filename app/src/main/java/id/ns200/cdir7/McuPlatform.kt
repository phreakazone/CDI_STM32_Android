...
enum class McuPlatform(
    ...
    STM32WB55(
        ...
        benchLoopbackPin = "PB6 (H_TOP.6 Uji Bangku)",
    ...
    ESP32_WROOM(
        ...
        pulserPin = "GPIO4 (Pin 19 - Kanan.13)",
        pulserPinDescription = "GPIO4 via komparator LM393 dari J1.10 (Pulser Pick-up)",
        gateCenterPin = "GPIO25 (Pin 9 - Kiri.9)",
        gateSidePin = "GPIO26 (Pin 10 - Kiri.10)",
        oemTapCenterPin = "GPIO16 (Pin 31 - Kanan.12)",
        oemTapSidePin = "GPIO17 (Pin 30 - Kanan.11)",
        strobePin = "GPIO27 (Pin 11 - Kiri.11)",
        fanRelayPin = "GPIO13 (Pin 15 - Kiri.15)",
        faultPin = "GPIO14 (Pin 12 - Kiri.12 Active-Low)",
        chargerPinA = "GPIO18 (Pin 9 - Kanan.9 MCPWM Push)",
        chargerPinB = "GPIO19 (Pin 8 - Kanan.8 MCPWM Pull)",
        adctpsPin = "GPIO36 / VP (Pin 3 - Kiri.3 ADC1_CH0)",
        adctempPin = "GPIO39 / VN (Pin 4 - Kiri.4 ADC1_CH3)",
        adctpsRefPin = "GPIO34 (Pin 5 - Kiri.5 ADC1_CH6)",
        adchvcPin = "GPIO35 (Pin 6 - Kiri.6 ADC1_CH7)",
        adchvsPin = "GPIO32 (Pin 7 - Kiri.7 ADC1_CH4)",
        adcvbatPin = "GPIO33 (Pin 8 - Kiri.8 ADC1_CH5)",
        benchLoopbackPin = "GPIO5 (Pin 10 - Kanan.10 Uji Bangku SAJA)",
