...
const components = [
  ...
  {ref:'FMAIN',value:'5A',kind:'axial',x:25,y:125,pins:[['1','IGN_12V'],['2','VIN_FUSED']]},
  {ref:'DREV',value:'SB560',kind:'axial',x:39,y:125,pins:[['A','VIN_FUSED'],['K','VIN_PROT']]},
  {ref:'TVS_IN',value:'SMBJ33A/P6KE33A',kind:'axial',x:53,y:118,pins:[['A','GND_STAR'],['K','VIN_PROT']]},
  {ref:'L_IN',value:'47uH 5A',kind:'axial',x:53,y:125,pins:[['1','VIN_PROT'],['2','VIN_FILT']]},
  {ref:'C_IN',value:'470uF 35V',kind:'axial',x:67,y:118,pins:[['-','GND_STAR'],['+','VIN_FILT']]},
  {ref:'FLOGIC',value:'1A',kind:'axial',x:67,y:125,pins:[['1','VIN_FILT'],['2','VIN_LOGIC']]},
  {ref:'UBUCK',value:'MP1584 MODULE',kind:'quad',x:82,y:122,pins:[['1','VIN_LOGIC'],['2','GND_STAR'],['3','5V_LOGIC'],['4','GND_LOGIC']]},
  {ref:'FHV',value:'3A',kind:'axial',x:105,y:125,pins:[['1','VIN_FILT'],['2','VIN_HV_FUSED']]},
  {ref:'SW1',value:'SERVICE HV',kind:'axial',x:120,y:125,pins:[['1','VIN_HV_FUSED'],['2','VIN_HV']]},
  {ref:'NT1',value:'GROUND STAR LINK',kind:'axial',x:12,y:125,pins:[['1','GND_STAR'],['2','GND_POWER']]},
  ...
  {ref:'U2',value:'LM339N',kind:'dip',x:72,y:12,pitch:2.54,row:7.62,pins:[
    ...
    ['6','ISENSE'],['7','IREF'],['8','HV_C_FB'],['9','VOV_REF'],['10','HV_S_FB'],['11','VOV_REF'],
  ...
  {ref:'QFAN',value:'BC337-40',kind:'triple',x:55,y:57,pins:[['C','FAN_RELAY'],['B','FAN_BASE'],['E','GND_LOGIC']]},
  ...
  {ref:'QPC',value:'BC557B',kind:'triple',x:158,y:103,pins:[['C','SCR_GATE_C_R'],['B','QPC_BASE'],['E','VIN_HV']]},
  {ref:'QNS',value:'BC547B',kind:'triple',x:145,y:112,pins:[['C','QPS_BASE_R'],['B','GATE_S_BASE'],['E','GND_LOGIC']]},
  {ref:'QPS',value:'BC557B',kind:'triple',x:158,y:112,pins:[['C','SCR_GATE_S_R'],['B','QPS_BASE'],['E','VIN_HV']]}
];
...
const passives = [
  ...
  ['RTPS1','15k','TPS_SIG_RAW','TPS_SIG_DIV'],['RTPS2','27k','TPS_SIG_DIV','GND_LOGIC'],['RTPS3','1k','TPS_SIG_DIV','TPS_ADC'],
  ...
  ['RVM1','10k','3V3','VMID'],['RVM2','10k','VMID','GND_LOGIC'],['RVZ1','15k','5V_LOGIC','PICKUP_ZERO'],['RVZ2','10k','PICKUP_ZERO','GND_LOGIC'],
  ...
  ['RI1','120k','3V3','IREF'],['RI2','10k','IREF','GND_LOGIC'],['RIS','100R','ISENSE','ISENSE_ADC'],
  ['RVOV1','120k','5V_LOGIC','VOV_REF'],['RVOV2','100k','VOV_REF','GND_LOGIC'],
...
for (const [ref,val,a,b] of passives) {
  const power = /^(RPWM|RGA|RGB|RGPD|RI\d|RIS|RVOV)/.test(ref);
  ...
  if (power) {
    ...
    components.push({ref,value:val,kind:'axial',x:145+(n%5)*13,y:84+Math.floor(n/5)*7,pins:[['1',a],['2',b]],_group:'gatePassive'});
  } else {
    components.push({ref,value:val,kind:'axial',x:px,y:py,pins:[['1',a],['2',b]],_group:'logicPassive'});
    px += 12; if (px > 84) { px=48; py+=7; }
  }
}
...
for (const bank of [['C','HV_CENTER','HV_C_FB','HV_C_ADC'],['S','HV_SIDE','HV_S_FB','HV_S_ADC']]) {
  ...
  components.push({ref:`RHV${suffix}5`,value:'8.2k 1%',kind:'axial',x:184,y:suffix==='C'?25:28,pins:[['1',fb],['2','GND_LOGIC']]});
...
function board(variant) {
  id=1000;
  const ox=100, oy=100, w=mm(230), h=mm(135);
  const shape=[];
  ...
  shape.push(`SOLIDREGION~10~~${ox+mm(143)} ${oy+mm(5)} ${ox+mm(145)} ${oy+mm(5)} ${ox+mm(145)} ${oy+mm(130)} ${ox+mm(143)} ${oy+mm(130)}~npth~${gid()}`);
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 230 135" width="2300" height="1350"><rect width="230" height="135" fill="#0a0b0d"/><rect x="0" y="0" width="100" height="135" fill="#0c1c2b"/><rect x="100" y="0" width="45" height="135" fill="#2a210e"/><rect x="145" y="0" width="85" height="135" fill="#2b0e13"/><path d="M100 0V135M145 0V135" stroke="#ffffff" stroke-width="0.4" stroke-dasharray="2 1"/><text x="2" y="133" font-size="3" fill="#6ee7ff">LOGIC</text><text x="102" y="133" font-size="3" fill="#ffc857">POWER 12V</text><text x="147" y="133" font-size="3" fill="#ff6b6b">HV 345V</text>${svgParts}</svg>`;
